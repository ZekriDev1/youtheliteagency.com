...
document.querySelectorAll('.flag-circle').forEach(function (flag) {
	flag.addEventListener('click', function () {
		const selectedLanguage = this.getAttribute('data-lang');
		if (selectedLanguage === 'en') {
			googleTranslateChangeLanguage('en');
		} else if (selectedLanguage === 'fr') {
			googleTranslateChangeLanguage('fr');
		} else if (selectedLanguage === 'ar') {
			googleTranslateChangeLanguage('ar');
		}
	});
});

// Google Translate Function to Change Language
function googleTranslateChangeLanguage(lang) {
